...
router = APIRouter(tags=["Admin Districts"], dependencies=[Depends(has_role(ADMIN))] )
...
# UPLOAD DISTRICTS
@router.post("/admin/districts/upload")
...
# EXPORT DISTRICTS
@router.post("/admin/districts/export-csv", response_class=StreamingResponse)
