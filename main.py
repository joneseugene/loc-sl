...
from controllers.user.chiefdoms_controller import router as user_chiefdom_router  
...
app.include_router(super_chiefdom_router, prefix="/api")
...
app.include_router(user_chiefdom_router, prefix="/api")
